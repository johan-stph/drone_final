...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `johan-stph
`, `drone_final
`, `twitter_handle`, `linkedin_username`, `johannes.uni.kit@gmail.com
_client`, `johannes.uni.kit@gmail.com
`, `DRONE PROJECT
`, `This Project has the goal to land a tello drone on a turtle bot
`
...
2. Clone the repo
   ```sh
   git clone https://github.com/johan-stph
   /drone_final
   .git
   ```
...
See the [open issues](https://github.com/johan-stph
/drone_final
